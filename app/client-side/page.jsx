...
export default function ClientSide() {
  ...
  return (
    <div className="w-full h-full flex flex-col justify-start items-center mt-10 min-h-screen gap-2 font-[family-name:var(--font-geist-sans)]">
      <div className="w-full flex justify-center items-center gap-2">
        <ClientProfile me={me} signOut={signOut} />
        <Card width="w-40" height="h-36" title="Service Status" active={selectedTab === 0} onClick={() => handleTabChange(0)}>
          <div className="flex justify-between items-center">
            <div>8 services</div>
          </div>
        </Card>
      </div>
      <section className="w-full flex justify-center items-center gap-2" aria-label="Service Selections">
      ...
      <section className="w-full h-full relative" aria-label="Service Details">
